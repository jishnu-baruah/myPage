...
function useIsDark() {
  ...
  useEffect(() => {
    ...
    darkModeMedia.addEventListener('change', check);
    return () => {
      observer.disconnect();
      darkModeMedia.removeEventListener('change', check);
    };
  }, []);
  return isDark;
}
      ...
      >
        ...
        >
          <path
            ...
            strokeOpacity={isDark ? "0.05" : "0.12"}
            strokeWidth="0.5"
          ></path>
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                ...
                <stop stopColor="#bbb"></stop>
                <stop offset="32.5%" stopColor="#888"></stop>
                <stop offset="100%" stopColor="#222" stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
            ...
            >
              <stop offset="0.0666667" stopColor="#bbb"></stop>
              <stop offset="0.243243" stopColor="#bbb"></stop>
              <stop offset="0.43594" stopColor="#fff" stopOpacity="0"></stop>
            </radialGradient>
          </defs>
        </svg>
      </div>
